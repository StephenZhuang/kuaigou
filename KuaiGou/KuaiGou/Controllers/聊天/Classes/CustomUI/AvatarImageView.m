...
@implementation AvatarImageView (NIMDemo)

+ (instancetype)demoInstanceRecentSessionList{
    return [AvatarImageView demoInstance40x40];
}

+ (instancetype)demoInstanceContactDataList{
    return [AvatarImageView demoInstance30x30];
}

+ (instancetype)demoInstance40x40{
    AvatarImageView *avatarImageView = [[AvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
    avatarImageView.image = [UIImage imageNamed:@"DefaultAvatar.png"];
    return avatarImageView;
}

+ (instancetype)demoInstance30x30{
    AvatarImageView *avatarImageView = [[AvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
    avatarImageView.image = [UIImage imageNamed:@"DefaultAvatar.png"];
    return avatarImageView;
}

+ (instancetype)demoInstanceTeamCardHeader{
    AvatarImageView *avatarImageView = [[AvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 55, 55)];
    return avatarImageView;
}

+ (instancetype)demoInstanceTeamMember{
    AvatarImageView *avatarImageView = [[AvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 37, 37)];
    return avatarImageView;
}
