...
@interface GroupedDataCollection () {
...
@implementation GroupedDataCollection
...
- (void)setMembers:(NSArray *)members
{
    ...
    for (id<GroupMemberProtocol>member in members) {
...
- (void)sortGroupMember
{
    [_groups enumerateObjectsUsingBlock:^(Pair *obj, NSUInteger idx, BOOL *stop) {
        ...
        [groupedMembers sortUsingComparator:^NSComparisonResult(id<GroupMemberProtocol> member1, id<GroupMemberProtocol> member2) {
